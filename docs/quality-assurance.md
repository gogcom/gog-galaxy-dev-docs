...
- **Outdated OpenSSL libraries in Linux games**: Please make sure to ship your Linux build of the game with all necessary OpenSSL libraries. Recently, we've noticed that many builds of Game Maker games are missing libcrypto.so.1.0.0, among other contents of old open OpenSSL releases. If your game uses outdated OpenSSL libraries (e.g. 1.0 or 1.0.1), then please make sure to put them in a build of your game!
